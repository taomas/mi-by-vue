	...
	data () {
		return {
			...
			hot: [
				...
				reviewDesc: '穿着这衣服，真是舒服，就想抱着女朋友的感觉一样 ', reviewAuthor: '574081459', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1161000019.html', imgUrl: 'http://i3.mifile.cn/a4/e8f5a80c-7f57-4f7b-97fc-c446059d2381', title: '小米短袖T恤 水管工米兔', price: '29', oldPrice: '39', heat: '3567',
				reviewDesc: '感觉非常不错，特别是这上边的图案，萌萌哒！', reviewAuthor: '478670150', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1162200008.html', imgUrl: 'http://i3.mifile.cn/a4/d3897b3a-59b4-4cdb-a726-f318f0ee44b6', title: '小米短袖T恤 新国货', price: '29', oldPrice: '39', heat: '476',
				reviewDesc: '货品收到了！这个印花太耀眼了。', reviewAuthor: '乌之江下面', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1161000025.html', imgUrl: 'http://i3.mifile.cn/a4/23c8122a-3bf4-4675-abb2-aca349aa1923', title: '小米V领短袖T恤 女款', price: '29', oldPrice: '39', heat: '3075',
				reviewDesc: '好穿级了，纯棉，手感不错，性价比高', reviewAuthor: '狗都爱吃肉', reviewStatus: true, discount: false},
			...
			clothes: [
				...
				reviewDesc: '衣服质量不错，样式也不错 ', reviewAuthor: '小紅帽0809', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1161000027.html', imgUrl: '//i3.mifile.cn/a4/a2973973-b7f1-4431-988b-449c0d068419', title: '小米V领短袖T恤 女款', price: '29', oldPrice: '39', heat: '3075',
				reviewDesc: '好穿级了，纯棉，手感不错，性价比高', reviewAuthor: '狗都爱吃肉', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1161000018.html', imgUrl: '//i3.mifile.cn/a4/T1ReJ_B_Kv1RXrhCrK.jpg', title: '小米短袖T恤 小熊米兔', price: '29', oldPrice: '39', heat: '4512',
				reviewDesc: '女朋友说了，衣服不错就是人丑了点。', reviewAuthor: 'Mi_940790865', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1161000020.html', imgUrl: '//i3.mifile.cn/a4/357bebdd-6e77-4c43-a33c-b8287caace2e', title: '小米短袖T恤 水管工米兔', price: '29', oldPrice: '39', heat: '3567',
				reviewDesc: '感觉非常不错，特别是这上边的图案，萌萌哒！', reviewAuthor: '478670150', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1161000032.html', imgUrl: '//i3.mifile.cn/a4/T1GXYgBgJv1RXrhCrK.jpg', title: '小米短袖POLO衫 女款', price: '59', oldPrice: '39', heat: '1023',
				reviewDesc: '颜色很正，质地好，我继续支持小米！', reviewAuthor: 'Mi_657996558', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1161000021.html', imgUrl: '//i3.mifile.cn/a4/T1MIC_BTLv1RXrhCrK.jpg', title: '小米短袖T恤 轻松米兔', price: '29', oldPrice: '39', heat: '4629',
			...
			rabbit: [
				...
				{sourceUrl: '//item.mi.com/1162200023.html', imgUrl: '//i1.mifile.cn/a1/pms_1464947945.39918897!220x220.jpg', title: '拳击手米兔', price: '49', oldPrice: '80', heat: '80',
				reviewDesc: '拳击手米兔～(LIGHTWEIGHT BOXING ...', reviewAuthor: 'Bestdiao-HC', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1162000069.html', imgUrl: '//i1.mifile.cn/a1/pms_1463975728.16077005!220x220.jpg', title: '悟空米兔', price: '49', oldPrice: '229', heat: '229',
				reviewDesc: '不错，我非常喜欢，斩妖除魔。猴年大吉。', reviewAuthor: '丛晓宇', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1162000070.html', imgUrl: '//i1.mifile.cn/a1/pms_1463973922.4853847!220x220.jpg ', title: '飞行员米兔屏幕擦挂饰', price: '29', oldPrice: '204', heat: '204',
				reviewDesc: '做工精致，好喜欢好喜欢', reviewAuthor: '刘冠佐', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1134900318.html', imgUrl: '//i1.mifile.cn/a1/T1dRZTB_xT1RXrhCrK!220x220.jpg', title: '经典版米兔', price: '29', oldPrice: '3.9万', heat: '3.9万',
				reviewDesc: '可爱(⊙o⊙)哦，好多女孩向我要呢', reviewAuthor: '273294452', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1161200074.html', imgUrl: '//i3.mifile.cn/a4/T1zVZjBmJv1RXrhCrK.jpg', title: '文艺版米兔', price: '49', oldPrice: '263', heat: '263',
			...
			around: [
				...
				{sourceUrl: '//item.mi.com/1153700036.html', imgUrl: '//i1.mifile.cn/a1/T1fADvByVv1RXrhCrK!220x220.jpg', title: '小米皮质记事本', price: '19', oldPrice: '199', heat: '5018',
				reviewDesc: '这是我有史以来看到的最漂亮的笔记本，不管是皮的材质，...', reviewAuthor: 'zhangqy112233', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1162800009.html', imgUrl: 'http://i3.mifile.cn/a4/5a28d943-ef5d-4920-a89a-7f1bce6c5b35', title: '米家LED随身灯 增强版', price: '19.9', oldPrice: '199', heat: '2261',
				reviewDesc: '很好用！特别是五挡开关灯，好用！方便！', reviewAuthor: '86505510', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1134900194.html', imgUrl: '//i1.mifile.cn/a1/T1UmxTBQhv1RXrhCrK!220x220.jpg', title: '手机支架 小蜜蜂', price: '19', oldPrice: '199', heat: '7万',
				reviewDesc: '自从有了你再也不用担心手会酸了，就是离不开它了，这可...', reviewAuthor: '861173399', reviewStatus: true, discount: false},
				{sourceUrl: '//www.mi.com/transformers/', imgUrl: '//i1.mifile.cn/a1/pms_1463971828.3961404!220x220.jpg', title: '变形金刚特别版声波', price: '169', oldPrice: '199', heat: '1691',
				reviewDesc: '平板变成金刚！超乎想象！好酷！喜欢，希望还有系列的产...', reviewAuthor: 'Paul', reviewStatus: true, discount: false},
				{sourceUrl: '//item.mi.com/1134900289.html', imgUrl: '//i1.mifile.cn/a1/T198bTBbAv1RXrhCrK!220x220.jpg', title: '小米百变随身杯', price: '39', oldPrice: '199', heat: '1.3万',
			...
			bags: [
				...
				reviewDesc: '这箱子很好，外观漂亮，实用性强。很轻，有点软但不影响...', reviewAuthor: '子书雁', reviewStatus: true, discount: false},
				...
				reviewDesc: '设计简约好看，轮子静音顺滑。前几天去香港刚好用上了', reviewAuthor: '黄黄志刚', reviewStatus: true, discount: false},
